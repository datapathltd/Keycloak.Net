...
namespace Keycloak.Net.Tests
{
    public partial class KeycloakClientShould
    {
        ...
        public async Task GetPermissionsTokenPermissionsAsync(string realm, string clientId)
        {
            ...
            var permissions = await _client.GetPermissionsTokenPermissionsAsync("http://localhost/auth", realm, clientId, accessToken, requestedPermissions);
            Assert.True(permissions.Any());
        }
        ...
        public async Task GetSuccessfulPermissionsDecisionAsync(string realm, string clientId)
        {
            ...
            var result = await _client.GetPermissionsDecisionAsync("http://localhost/auth", realm, clientId, accessToken, requestedPermissions);
            Assert.True(result);
        }
